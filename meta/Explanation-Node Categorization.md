...
- **Advice**: Nodes describing well-known principles, heuristics, sayings, rules of thumb, and generally, advice. The advice need [not be good or even correct](https://en.wikipedia.org/wiki/Security_through_obscurity), but should be generally recognized by the field. 
