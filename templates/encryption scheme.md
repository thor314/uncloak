...
audience: all
completion: .1
tags: type/object/math/algorithm/encryption,
<% tp.file.cursor(1) %>
date-origin: 
date-broken: 
---
...
<% tp.file.cursor(2) %> *Prepend `encryption-TITLE` to your title. Don't forget to refile this file to the correct location with Alt-R.*
