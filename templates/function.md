...
audience: all
completion: .1
tags: type/object/math/function,
<% tp.file.cursor(1) %>
---

<% tp.file.cursor(2) %> *Prepend `function-TITLE` to your title. Don't forget to refile this file to the correct location with Alt-R.*
