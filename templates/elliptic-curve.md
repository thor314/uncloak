...
audience: all
completion: .1
tags: type/object/math/function/elliptic-curve,
<% tp.file.cursor(1) %>
---

<% tp.file.cursor(2) %> *Prepend `elliptic_curve-TITLE` to your title. Don't forget to refile this file to the correct location with Alt-R.*
