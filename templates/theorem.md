...
audience: all
completion: .1
tags: type/statement/proven/theorem, 
<% tp.file.cursor(1) %>
---

<% tp.file.cursor(2) %> *Prepend `theorem-TITLE` to your title. Don't forget to refile this file to the correct location with Alt-R.*
